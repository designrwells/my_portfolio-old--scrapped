...
var DragControls = /** @class */ (function () {
     ...
     * @public
     */
    DragControls.prototype.start = function (originEvent, _a) {
        var _this = this;
    ...
    DragControls.prototype.cancelDrag = function () {
        unblockViewportScroll();
        this.isDragging = false;
    ...
    DragControls.prototype.stop = function (event, info) {
        var _a;
    ...
    DragControls.prototype.recordBoxInfo = function (constraints) {
        if (constraints) {
    ...
    DragControls.prototype.snapToCursor = function (event) {
        var _this = this;
        var transformPagePoint = this.props.transformPagePoint;
    ...
    DragControls.prototype.setPoint = function (axis, value) {
        this.point[axis] = value;
    };
    DragControls.prototype.updatePoint = function (axis, offset) {
    ...
    DragControls.prototype.updateProps = function (_a) {
        var _this = this;
    ...
    DragControls.prototype.applyConstraintsToPoint = function (constraints) {
        var _this = this;
    ...
    DragControls.prototype.animateDragEnd = function (velocity) {
        var _this = this;
    ...
    DragControls.prototype.scalePoint = function () {
        var _this = this;
    ...
    DragControls.prototype.mount = function (element) {
        var _this = this;
...
function useDrag(props, ref, values, controls) {
    ...
    var transformPagePoint = useContext(MotionPluginContext).transformPagePoint;
    var dragControls = useConstant(function () { return new DragControls({ ref: ref, values: values, controls: controls }); });
 ...
 * @public
 */
var GroupDragControls = /** @class */ (function () {
    function GroupDragControls() {
        this.componentControls = new Set();
    }
    GroupDragControls.prototype.subscribe = function (controls) {
        var _this = this;
        this.componentControls.add(controls);
        return function () { return _this.componentControls.delete(controls); };
    };
    GroupDragControls.prototype.start = function (event, options) {
        this.componentControls.forEach(function (controls) {
            controls.start(event.nativeEvent || event, options);
        });
    };
    return GroupDragControls;
}());
var createDragControls = function () { return new GroupDragControls(); };
/**
 * @public
 */
